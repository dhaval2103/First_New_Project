                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="media align-items-center">
                                            ...
                                            <div class="media-body overflow-hidden">
                                                ...
                                                <p class="text-muted text-truncate mb-0">Sed ut perspiciatis unde
                                                    omnis iste</p>
                                            </div>
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col">
                                <div class="text-sm-right mt-2 mt-sm-0">
                                    <a href="{{ route('stripe') }}" class="btn btn-success btn-lg">
                                        <i class="uil uil-shopping-cart-alt mr-1"></i> Procced </a>
                                </div>
                            </div> <!-- end col -->
                        </div> <!-- end row-->
                    </div>
                            ...
                            <div class="card-body">
                                <div class="p-3 bg-light mb-4">
                                    <h5 class="font-size-16 mb-0">Order Summary <span
                                            class="float-right ml-2">#MN0124</span></h5>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-centered mb-0 table-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row"><img src="assets/images/product/img-1.png" alt="product-img"
                                                        title="product-img" class="avatar-md">
                                                </th>
                                                <td>
                                                    <h5 class="font-size-14 text-truncate"><a
                                                            href="ecommerce-product-detail.html" class="text-dark">Nike
                                            ...
                                            <tr>
                                                <th scope="row"><img src="assets/images/product/img-2.png" alt="product-img"
                                                        title="product-img" class="avatar-md">
                                                </th>
                                                <td>
                                                    <h5 class="font-size-14 text-truncate"><a
